...
LOAD DATA INFILE '/home/shruti/Documents/AnalysisTool/data/sector_id_master.txt' INTO TABLE SECTOR_MASTER FIELDS TERMINATED BY '|';
...
INSERT INTO EQM_EQUITY_SHARE_DATA (COMPANY_ID, RECORD_DATE, HIGH, LOW, SALES_PER_SHARE_UNADJ, EARNINGS_PER_SHARE_UNADJ, DILUTED_EARNINGS_PER_SHARE, CASH_FLOW_PER_SHARE_UNADJ, DIVIDENDS_PER_SHARE_UNADJ, ADJ_DIVIDENDS_PER_SHARE, DIVIDEND_YIELD_EOY, BOOK_VALUE_PER_SHARE_UNADJ, ADJ_BOOK_VALUE_PER_SHARE, SHARES_OUTSTANDING_EOY, BONUS_RIGHTS_CONVERSIONS, PRICE_BY_SALES_RATIO, AVG_PE_RATIO, PRICE_BY_CASHFLOW_RATIO_EOY, PRICE_BY_BOOK_VALUE_RATIO, DIVIDEND_PAYOUT, AVG_MARKET_CAP, NO_OF_EMPLOYEES, TOTAL_WAGES_PER_SALARY, AVG_SALES_PER_EMPLOYEE, AVG_WAGES_PER_EMPLOYEE, AVG_NET_PROFIT_PER_EMPLOYEE)
SELECT (SELECT COMPANY_ID FROM COMPANY_MASTER CM WHERE TEMP_1.COMPANY_CODE = CM.SYMBOL_EQM), date('now') RECORD_DATE,
...
INSERT INTO EQM_INCOME_DATA (COMPANY_ID, RECORD_DATE, NET_SALES, OTHER_INCOME, TOTAL_REVENUES, GROSS_PROFIT, DEPRECIATION, INTEREST, PROFIT_BEFORE_TAX, MINORITY_INTEREST, PRIOR_PERIOD_ITEMS, EXTRAORDINARY_INC_EXP, TAX, PROFIT_AFTER_TAX, GROSS_PROFIT_MARGIN, EFFECTIVE_TAX_RATE, NET_PROFIT_MARGIN)
SELECT (SELECT COMPANY_ID FROM COMPANY_MASTER CM WHERE TEMP_1.COMPANY_CODE = CM.SYMBOL_EQM), date('now') RECORD_DATE,
...
INSERT INTO EQM_CASHFLOW (COMPANY_ID, RECORD_DATE, FROM_OPERATIONS, FROM_INVESTMENTS, FROM_FINANCIAL_ACTIVITY, NET_CASHFLOW)
SELECT (SELECT COMPANY_ID FROM COMPANY_MASTER CM WHERE TEMP_1.COMPANY_CODE = CM.SYMBOL_EQM), date('now') RECORD_DATE,
